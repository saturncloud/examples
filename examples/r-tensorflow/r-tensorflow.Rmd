...
description: "Use the RStudio Keras package to train a model on a GPU"
...
Once that's complete we split the data into the X 3D-matrix of model input and
y matrix of targets. This last splitting is done on an nparray,
...
those values into probabilities. Since this is a multiclassification problem,
