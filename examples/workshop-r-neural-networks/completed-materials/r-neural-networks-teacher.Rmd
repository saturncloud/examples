...
# We also tried adjusting to 32 units and adding an extra layer
output <-
  input %>%
...
output_v2 <-
  layer_concatenate(list(intermediate_v2_processing, input_v2_species)) %>%
  layer_dense(num_characters) %>%
  layer_activation("softmax")
